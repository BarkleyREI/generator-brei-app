...
var _test_brei_sass_files = module.exports._test_brei_sass_files = function (prefix) {
	...
	assert.file([
		...
		pre + 'app/sass/helpers/_user-markup.scss',
		...
		pre + 'app/sass/modules/_global-footer.scss',
		pre + 'app/sass/modules/_global-header.scss',
		pre + 'app/sass/modules/_global.scss',
		pre + 'app/sass/partials/_assemble-partials.scss',
		pre + 'app/sass/partials/_logo.scss',
		pre + 'app/sass/partials/_primary-nav.scss',
		pre + 'app/sass/templates/_assemble-templates.scss',
		pre + 'app/sass/templates/_home-page.scss',
		pre + 'app/sass/templates/_index.scss',
